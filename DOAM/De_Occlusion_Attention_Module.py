...
class DOAM(nn.Module):
	def __init__(self, mode=None):
		...
		self.conv2d_1_1.add_module('bn1', self.bn1)
		...
		self.conv2d_1_attention.add_module('bn2', self.bn2)
		...
		self.conv2d_2_attention.add_module('bn3', self.bn3)
		...
		self.conv2d_3_attention.add_module('bn4', self.bn4)
		...
		self.conv2d_4_attention.add_module('bn5', self.bn5)
		...
		self.conv2d_5_attention.add_module('bn6', self.bn6)
		...
		self.conv2d_1_rgb_attention.add_module('bn7', self.bn7)
		...
		self.conv2d_2_rgb_attention.add_module('bn8', self.bn8)
		...
		self.conv2d_3_rgb_attention.add_module('bn9', self.bn9)
		...
		self.conv2d_4_rgb_attention.add_module('bn10', self.bn10)
		...
		self.conv2d_5_rgb_attention.add_module('bn11', self.bn11)
		...
		self.conv2d_1_rgb_red_concat_5.add_module('bn12', self.bn12)
		...
		self.conv2d_1_rgb_red_concat_10.add_module('bn13', self.bn13)
		...
		self.conv2d_1_rgb_red_concat_15.add_module('bn14', self.bn14)
	...
	def RIA(self, x):
		...
		for i in range(30):
			for j in range(30):
				x_pooled_upsample_10[:, :, i * 10:(i + 1) * 10, j * 10:(j + 1) * 10] = x_pooled_10[:, :, i, j].unsqueeze(
					-1).unsqueeze(-1)

		for i in range(20):
			for j in range(20):
				x_pooled_upsample_15[:, :, i * 15:(i + 1) * 15, j * 15:(j + 1) * 15] = x_pooled_15[:, :, i, j].unsqueeze(
					-1).unsqueeze(-1)
